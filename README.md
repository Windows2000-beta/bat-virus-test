...
`[!] Данный скрипт не содержит вредоносное ПО и не поддерживает его распространение. [!]`
...
<hr>
<h1 span=color"yellow">Как использовать:</h1>
...
2. Перейдите в **папку** и запустите файл:
    ...
    - `.ps1`: вроде тоже можно запустить с двойным нажатием или через консоль **start [FILE_NAME].ps1
---
##  **Требования:**
